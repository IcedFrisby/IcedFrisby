...
class Frisby {
  ...
  _scheduleTimeout(done) {
    ...
    this._requestTimeoutId = setTimeout(() => {
      ...
      this._finishWithContinuation(done)
    }, timeoutMillis)
  }
  ...
  _maybePerformRetry(done) {
    ...
    setTimeout(() => this._makeRequest(done), this._attempts.backoffMillis)
